...
image_num = st.sidebar.radio('생성할 이미지 개수를 선택하세요.', image_num_options, index=0, horizontal=True)
...
detail_description = st.sidebar.radio('상세 묘사를 추가하겠습니까?', ['Yes', 'No'], index=1 ,horizontal=True)
